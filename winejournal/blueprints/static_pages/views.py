...
@staticPages.route('/gconnect', methods=['POST'])
@csrf.exempt
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('winejournal/client_secrets.json', scope='')
    ...
    return '<p>You are successfully logged in</p>'



# DISCONNECT - Revoke a current user's token and reset their login_session
@staticPages.route('/gdisconnect')
@csrf.exempt
def gdisconnect():
